...
1) Go to this [space](https://huggingface.co/spaces/Jofthomas/Pokemon_showdown)
2) Choose a name at the top right
3) Search for a user named like the currently available agent displayed in the stream or on the [space](https://huggingface.co/spaces/Jofthomas/twitch_streaming)
4) Send a battle invitation. (Only One agent is available concurently)
