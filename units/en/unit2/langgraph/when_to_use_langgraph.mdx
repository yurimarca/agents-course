...
The classes from LangChain might be used in LangGraph, but does not HAVE to be used. 

The packages are different and can be used in isolation, but, in the end, all ressources you will find online use both packages hand in hand.
