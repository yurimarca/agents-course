...
You can follow the process [in this notebook](https://huggingface.co/agents-course/notebooks/resolve/main/unit2/langgraph/mail_sorting.ipynb) or **run the code yourself**.
## Our Workflow
...
email_graph.to_graph().draw("alfred_email_graph.png")
```
