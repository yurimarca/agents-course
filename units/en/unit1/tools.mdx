...
This means that **any of the frameworks that implement MCP can use tools that are defined in the MCP**.
Getting rid of the need to reimplement the same tool interface for each framework.
